...
# Partition along one of the detector axes
num_parts = 4
my_id = 0
split_axis = 1
num_px_per_part = det_shape[split_axis] // num_parts
slices = [slice(i * num_px_per_part, (i + 1) * num_px_per_part)
          for i in range(num_parts - 1)]
slices.append(slice((num_parts - 1) * num_px_per_part, None))
